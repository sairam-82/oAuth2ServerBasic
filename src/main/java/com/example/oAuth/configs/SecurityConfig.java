...
//        var user= User.withUsername("sai").password("1234").build();
//        usd.createUser(user);
//        return usd;
//    }
    @Bean
...
//        http.formLogin(Customizer.withDefaults()).authorizeHttpRequests(Customizer.withDefaults());
        http.formLogin(Customizer.withDefaults()).authorizeHttpRequests(authorize-> authorize.requestMatchers("/demo").hasAuthority("read"));
        return http.build();
    }
